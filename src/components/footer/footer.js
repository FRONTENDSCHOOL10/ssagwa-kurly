        ...
        <div class="main-inner">
          <div class="footer-top">
            ...
            <section class="Company-info" aria-label="회사 정보">
              ...
              <ul class="SNS-links" aria-label="SNS 링크">
                ...
                <li><a href="https://m.post.naver.com/marketkurly" target='_blank' aria-label="칼리 네이버 포스트"><img src="/ssagwa-kurly/src/assets/svg/NaverPost.svg" alt=""></a></li>
                <li><a href="https://www.youtube.com/channel/UCfpdjL5pl-1qKT7Xp4UQzQg" target='_blank' aria-label="칼리 유튜브"><img src="/ssagwa-kurly/src/assets/svg/Youtube.svg" alt=""></a></li>
              </ul>
            </section>
          </div>
          <div class="footer-middle">
              ...
              <a href="/" target='_blank'>
                <img src="/ssagwa-kurly/src/assets/svg/isms.svg" alt="">
                <p>[인증범위] 마켓칼리 쇼핑몰 서비스 개발 운영<br />(심사받지 않은 물리적 인프라 제외)<br /> [유효기간] 2022.01.19 ~ 2025.01.18</p>
              </a>
              <a href="/" target='_blank'>
                <img src="/ssagwa-kurly/src/assets/svg/logo_privacy.svg" alt="">
                <p>개인정보보호 우수 웹사이트<br />개인정보처리시스템 인증 (ePRIVACY PLUS)</p>
              </a>
              <a href="/" target='_blank'>
                <img src="/ssagwa-kurly/src/assets/svg/logo_tosspayments.svg" alt="">
                <p>토스페이먼츠 구매안전(에스크로)서비스<br />를 이용하실 수 있습니다.</p>
              </a>
              <a href="/" target='_blank'>
                <img src="/ssagwa-kurly/src/assets/svg/logo_wooriBank.svg" alt="">
